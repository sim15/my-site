          ...
          <Grid>
            <Collapse.Group css={{ padding: 0 }}>
              ...
              <ProjectItemCollapse title="Moderately Hard Functions" links={[]}>
                ...
                <p>Simon Beyzerov, Leonid Reyzin @ Boston University</p>
                <h3>About</h3>
                <p>(Still in the works!)</p>

                <p>
                  This project came about during the summer of 2022, during
                  which Professor Leonid Reyzin from BU introduced me to this
                  very weird, tough problem at the intersections of complexity
                  theory, cryptography, engineering, and even a bit of
                  physics(!!). I&apos;ve tried to include a brief (hopefully
                  accessible) introduction to the problem for anyone curious!
                </p>
                <h3>Mini-summary</h3>
                <p>
